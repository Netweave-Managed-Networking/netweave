...
$mockResourceCategories = [
    ...
    31 => [
        'title' => 'Ein langer Titel zur Prüfung der maximalen Bytegröße von 63.',
        'definition' => 'Diese Kategorie wurde speziell entwickelt, um die maximale Zeichenanzahl in Beschreibungen zu überprüfen und sicherzustellen, dass diese korrekt verarbeitet und gespeichert wird. Sie enthält einen längeren Text von exakt 1023 Bytes, der dazu dient, die Funktionsweise von Datenbanken, Formularen oder Frontend-Komponenten zu testen. Die Beschreibung könnte Details zu beliebigen Themen enthalten, wie z.B. den Einsatz von Systemen in verschiedenen Anwendungsbereichen, deren potenzielle Vorteile und die Herausforderungen, die bei Implementierung auftreten können. Durch diese Kategorie kann zudem die Auswirkung langer Texte aufs Layout von Benutzeroberflächen überprüft werden, einschließlich ihrer Lesbarkeit und Benutzerfreundlichkeit. Solche Tests sind besonders wichtig für Projekt, bei denen mit variierenden Datenlängen gearbeitet wird, um sicherzustellen, dass die Software in allen Szenarien stabil und effektiv bleibt. Und noch ein paar Zeichen mehr. Und noch paar Zeichen mehr. Noch so ein Zeichen..',
    ],
];
