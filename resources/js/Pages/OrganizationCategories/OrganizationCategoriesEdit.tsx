...
export default function OrganizationCategoriesEdit({
  ...
  useEffect(
    // this is kind of a hack to set the categories state value to the organizationCategories PageProp value
    // this needs to be done because the state value is only updated in case of and add (api returns json)
    // the state value will not be updated by the frontend in case of an update or delete
    // in case of an update or delete the backend will redirect to the same page with the updated organizationCategories prop value
