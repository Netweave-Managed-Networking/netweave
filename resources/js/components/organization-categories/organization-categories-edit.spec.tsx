...
jest.mock('@/components/organization-categories/organization-category-edit', () => () => <div>OrganizationCategoryEdit</div>);

// Mock the OrganizationCategoryAdd component
jest.mock(
  '@/components/organization-categories/organization-category-add',
  () =>
