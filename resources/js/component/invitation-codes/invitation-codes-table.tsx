import CheckMark from '@/component/icon/check-mark';
import CrossMark from '@/component/icon/cross-mark';
import { InvitationCodeAddButton } from '@/component/invitation-codes/invitation-code-add-button';
import { InvitationCodeDeleteButton } from '@/component/invitation-codes/invitation-code-delete-button';
import InvitationCodeInvitationLinkButton from '@/component/invitation-codes/invitation-code-invitation-link-button';
import { UserDeleteButton } from '@/component/users/user-delete-button';

import Table, { Row } from '@/component/utils/table';
