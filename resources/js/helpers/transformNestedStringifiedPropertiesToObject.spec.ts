import { transformNestedStringifiedPropertiesToObject } from './transformNestedStringifiedPropertiesToObject';
...
describe('transformNestedStringifiedPropertiesToObject', () => {
  it('should transform a single nested property', () => {
    ...
    expect(transformNestedStringifiedPropertiesToObject(input)).toEqual(
      expected
    );
  });
